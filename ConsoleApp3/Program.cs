...
namespace ConsoleApp3
{
    class Program
    {
        ...
        {
            string ServiceBusConnectionString = "sb://pharma-nexus-dev.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=g2qJ4cxKQ03+2baC+if3Ui6LH7wE0827RXbGHjqkGvA=";
            string TopicName = "centrictesttopic";
            string SubscriptionName = "CentricTopicTestSubscription";
